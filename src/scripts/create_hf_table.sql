-- Function to create HuggingFace embeddings table
create or replace function create_hf_embeddings_table()
returns void
language plpgsql
as $$
begin
    ...
    create table if not exists huggingface_embeddings (
        ...
        course_content text,
        embedding vector(512),  -- HuggingFace embeddings are 512-dimensional
